        ...
        <div className="maxwidth-xl mx-auto wrapper">
          ...
          <div className="wrapper-y grid is-multi-col mostly-2">
            ...
            <div className="smalltext">
              <p>
                The federal agency for consumer protection in Nigeria website
                design and development was done to push the agency's activities
                and what it stood for in service of Nigerians into the public
                eye.
              </p>
              <p>
                Before the project was initiated, many consumers in the public
                were not aware of the rights they had as consumers of goods and
                services and the protection act that was put in place for their
                benefit
              </p>
              <p>
                Most of the content from their old site as well as newly created
                content for about the agency had to be put in the same place.
              </p>
            </div>
          </div>
          ...
          <div className="wrapper-y will-grow">
            <p className="smalltext maxwidth-tb">
              Informative and other instructional materials were also placed on
              the website for visitors and consumers in readily accessible
              formats.
            </p>
            <div className="project-feature-image bg-brandblue">
          ...
          <div className="wrapper-y will-grow">
            <p className="smalltext maxwidth-tb">
              Updates on the agency's activities, from press releases,
              publications, as well as news and events were all accounted for.
            </p>
            <div className="project-feature-image bg-brandblue">
              <Img
