              ...
              <div className="bg-t-white w-100 h-100 d-flx flex-dir-col j-c-fe">
                <div className="bg-t-black px-1 pt-1 pb-3">
                  <p className="co-white hometext mb-2">
                    I’m a product designer and developer contrubuting to make the web better, one product at a time.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="left-50 left-50-content min-height-80-vh wrapper-x h-100">
            <div className="w-100 h-100-break d-flx flex-dir-col j-c-c">
              ...
              <div className="d-flx pb-1 mobile-center">
                <a href="https://linkedin.com/in/psybug" className="d-blk prefix is-even-wider">
                ...
                <a href="https://twitter.com/psybuglite" className="d-blk suffix prefix is-even-wider">
                  <svg width={25} height={25} viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="https://behance.com/psybug" className="d-blk suffix is-even-wider">
                  <svg width={25} height={25} viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
